...
from trainFC_nstk import load_train_objs
...
def generate_samples(model,ema,dataset,args):
    with ema.average_parameters():
        ...
        with torch.no_grad():
            ...
            conditioning_snapshots, past_snapshots, targets_SR, targets_FC, s, Reynolds_number = next(iter(dataset))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--forecast', default=False, type=bool, help='Forecasting')
